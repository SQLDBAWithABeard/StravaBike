...
def generateReadme():
    ...
    with open('README.md', 'w') as handle:
        ...
        handle.write('## Rides in 5 mile buckets by Type ?\n')
        handle.write('How many times do I ride in each 5 mile bucket by type of ride??\n\n')
        handle.write('![Number_of_Activities_and_Type_per_Distance](Number_of_Activities_and_Type_per_Distance.png?raw=true "Number_of_Activities_and_Type_per_Distance")\n\n')
        handle.write('## Rides in 5 mile buckets  ?\n')
        handle.write('How many times do I ride in each 5 mile bucket e??\n\n')
