...
def generateReadme():
    ...
    visualiseData.produceAverageSpeedOutside(AllActivities)
    visualiseData.produceAverageSpeed(AllActivities)
    visualiseData.produceAverageCadence(AllActivities)
    visualiseData.produceAveragePower(AllActivities)
    visualiseData.produceDistanceByDay(AllActivities)
    visualiseData.produceDistanceByDayRide(AllActivities)
    visualiseData.produceCadenceByDay(AllActivities)
